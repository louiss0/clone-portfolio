...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"ts/utils/selector.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.selectElementsByClass = exports.selectElementByClassOrId = void 0;

exports.selectElementByClassOrId = function (selector, choice) {
  if (choice === void 0) {
    choice = null;
  }
  ...
  if (choice === "class" && !selector.startsWith(".")) {
    ...
    var idSelector = selector.slice(start, end);
...
exports.selectElementsByClass = function (selector) {
...
var DOMSelectors = __importStar(require("./ts/utils/selector")); // ! Im selecting by id


var app = DOMSelectors.selectElementByClassOrId("#app");
},{"./ts/utils/selector":"ts/utils/selector.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
